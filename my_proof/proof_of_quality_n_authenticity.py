...
def get_risk_status_and_quality(risk_score: float):
        ...
        # Test cases
        # print(get_risk_status_and_quality(1))  # High Risk, Quality Score: 0.5
        # print(get_risk_status_and_quality(3))  # Moderate Risk, Quality Score: 0.7
        # print(get_risk_status_and_quality(6))  # Low Risk, Quality Score: 0.9
        # print(get_risk_status_and_quality(8))  # Very Safe, Quality Score: 1.0

        # individual_quality = max(0, 1 - riskScore); 
